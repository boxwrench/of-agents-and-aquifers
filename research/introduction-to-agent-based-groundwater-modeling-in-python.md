# Introduction to Agent-Based Groundwater Modeling in Python

> [!NOTE]
> **Source:** [Medium](https://example.com/python-groundwater-tutorial)  
...
- Sets up basic cellular agents behaving according to simple rules.
- Prepares variables for future reinforcement learning (RL) training loops.

## 📓 Personal Notes & Key Takeaways
- Useful code snippets to build upon for our `experiments/` sandbox.
